...
class HaberIsAlanPage extends StatefulWidget {
  int id;
  List<Map<String, dynamic>> persons = [];
  HaberIsAlanPage(this.id, this.persons);

  @override
  State<HaberIsAlanPage> createState() => _HaberIsAlanPageState(id, persons);
}

class _HaberIsAlanPageState extends State<HaberIsAlanPage> {
  int _id;
  List<Map<String, dynamic>> _persons = [];
  _HaberIsAlanPageState(this._id, this._persons);
    ...
    return Scaffold(
      body: SafeArea(
        ...
        children: [
          ...
          bottomNavigationBar(
              page: "home", context: context, id: _id, persons: _persons)
        ],
      )),
    );
  }
